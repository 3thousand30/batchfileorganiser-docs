...
[Get it on Microsoft Store](https://apps.microsoft.com/detail/9PB3Q7K9FVZQ){: .btn .btn-blue }
...
- [Getting Started](getting-started) — run your first scan and organise safely
- [Organise Modes](organise-modes) — understand the folder structures each mode creates
- [Duplicates and Undo](duplicates-and-undo) — how duplicate review and restore work
...
Found a bug or have a question? Email [hello@3thousand30.com](mailto:hello@3thousand30.com) or [open an issue](https://github.com/3thousand30/batchfileorganiser-docs/issues) on GitHub.
